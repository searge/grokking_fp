...
object Ch01Intro:
  ...
  /** Calculate the score of a word declaratively by subtracting 'a' count.
    ...
    * @return The number of characters in the word excluding 'a'.
    */
  def wordScore2(word: String): Int = word.length - word.count(_ == 'a')
  ...
  /** Remove all occurrences of a character from a string.
    ...
    */
  def stringWithoutChar(word: String, char: Char): String = word.filter(_ != char)
  ...
  /** Calculate word score by removing 'a' characters and counting length.
    ...
    * @return The number of characters in the word excluding 'a'.
    */
  def wordScore3(word: String): Int = stringWithoutChar(word, 'a').length
